...
const MyTechStack = () => {
  const data = [
    { logo: css, text: "CSS" },
    { logo: excel, text: "Excel" },
    { logo: express, text: "Express" },
    { logo: framer, text: "Framer" },
    { logo: git, text: "Git" },
    { logo: github, text: "Github" },
    { logo: html, text: "HTML" },
    { logo: javascript, text: "JavaScript" },
    { logo: mongo, text: "MongoDB" },
    { logo: postgre, text: "PostgreSQL" },
    { logo: node, text: "NodeJS" },
    { logo: postman, text: "Postman" },
    { logo: power, text: "PowerBI" },
    { logo: python, text: "Python" },
    { logo: react, text: "ReactJS" },
    { logo: tailwind, text: "TailwindCSS" },
    { logo: vercel, text: "Vercel" },
  ];
  ...
  return (
    <motion.div
      className={`compress ${style.myTechStack}`}
